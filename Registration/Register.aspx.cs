    ...
    public partial class Register : System.Web.UI.Page
    {
        ...
        protected void Button1_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                con.Open();
                string insertUser = "insert into [userinfo] (first_name,last_name,email,password,activation_code,is_active) values (@first_name,@last_name,@email,@password,@activation_code,@is_active)";
                ...
                mail.Subject = "Thank You For Registration with us";

                string emailBody = "";
                emailBody += "<h1>Hello " + firstname.Text.ToString() + "</h1>";
                emailBody += "Click Belo Link for activate your account.<br/>";
                emailBody += "<p><a href='http://localhost:64661/ActivateAccount.aspx?activation_code=" + activation_code + "&email=" + email.Text.ToString() + "'>click here to activate</a></p>";
                ...
                lblErrorMsg.Text = "You are Registered Successfully. Please check Your Email Inbox/Spam folder for activation Link";
                lblErrorMsg.ForeColor = System.Drawing.Color.Red;
                con.Close();
